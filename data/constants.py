...
font_small = pg.font.Font("media/fonts/angrybirds.ttf", 20)
...
angry_birds_logo = pg.transform.scale(angry_birds_logo, (screen_width*2//3, screen_height//3))
...
# BUTTON IMAGES AND RESPECTIVE RECTS
(w, h) = (60, 60)
...
info_button = pg.image.load("media/images/buttons/info.png")
info_button = pg.transform.scale(info_button, (w, h))
leaderboard_button = pg.image.load("media/images/buttons/leaderboard.png")
leaderboard_button = pg.transform.scale(leaderboard_button, (w, h))
...
info_rect = pg.Rect((200, 10), (w, h))
ground = screen_height * 0.87 ## check

gravity = 0.5
drag = 0.1

# IMAGES OF GAME OBJECTS
block_images = {
...
# UNIQUE SPEEDS AND DAMAGE CORRESPONDING TO EACH PROJECTILE
bird_speeds = {
    "Red" : 23,
    "Chuck" : 23,
    "Blues" : 23,
...
# BOMB DAMAGE AS A PUFF OF SMOKE - TO BE IMPLEMENTED 
